...
public class MovieDaoTestCase {
	...
	public void initDb() throws Exception {
	 ...
	 public void shouldAddMovie() throws Exception {
	     // WHEN
	     movieDao.addMovie("Indestructible");
		 // THEN
	     Connection connection = DataSourceFactory.getDataSource().getConnection();
	     Statement statement = connection.createStatement();
	     ResultSet resultSet = statement.executeQuery("SELECT * FROM movie WHERE title='Indestructible'");
	     assertThat(resultSet.next()).isTrue();
	     assertThat(resultSet.getInt("idmovie")).isNotNull();
	     assertThat(resultSet.getString("title")).isEqualTo("Indestructible");
